...
add wave -noupdate -radix hexadecimal -childformat {{/tb/padrao(7) -radix hexadecimal} {/tb/padrao(6) -radix hexadecimal} {/tb/padrao(5) -radix hexadecimal} {/tb/padrao(4) -radix hexadecimal} {/tb/padrao(3) -radix hexadecimal} {/tb/padrao(2) -radix hexadecimal} {/tb/padrao(1) -radix hexadecimal} {/tb/padrao(0) -radix hexadecimal}} -subitemconfig {/tb/padrao(7) {-radix hexadecimal} /tb/padrao(6) {-radix hexadecimal} /tb/padrao(5) {-radix hexadecimal} /tb/padrao(4) {-radix hexadecimal} /tb/padrao(3) {-radix hexadecimal} /tb/padrao(2) {-radix hexadecimal} /tb/padrao(1) {-radix hexadecimal} /tb/padrao(0) {-radix hexadecimal}} /tb/padrao
...
add wave -noupdate -group Compara_0 /tb/DUT/compara_dado_0/match
...
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/clock
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/reset
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/dado
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/pattern
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/prog
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/habilita
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/match
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/reg_padrao
add wave -noupdate -expand -group Compara_1 /tb/DUT/compara_dado_1/comparador
...
add wave -noupdate -group Compara_2 /tb/DUT/compara_dado_2/match
...
add wave -noupdate -group Compara_3 /tb/DUT/compara_dado_3/match
