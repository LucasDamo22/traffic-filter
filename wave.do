...
add wave -noupdate -radix hexadecimal -childformat {{/tb/padrao(7) -radix hexadecimal} {/tb/padrao(6) -radix hexadecimal} {/tb/padrao(5) -radix hexadecimal} {/tb/padrao(4) -radix hexadecimal} {/tb/padrao(3) -radix hexadecimal} {/tb/padrao(2) -radix hexadecimal} {/tb/padrao(1) -radix hexadecimal} {/tb/padrao(0) -radix hexadecimal}} -subitemconfig {/tb/padrao(7) {-height 15 -radix hexadecimal} /tb/padrao(6) {-height 15 -radix hexadecimal} /tb/padrao(5) {-height 15 -radix hexadecimal} /tb/padrao(4) {-height 15 -radix hexadecimal} /tb/padrao(3) {-height 15 -radix hexadecimal} /tb/padrao(2) {-height 15 -radix hexadecimal} /tb/padrao(1) {-height 15 -radix hexadecimal} /tb/padrao(0) {-height 15 -radix hexadecimal}} /tb/padrao
...
add wave -noupdate -group Compara_1 /tb/DUT/compara_dado_1/match
